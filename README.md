...
jack is a 2D platformer developed in Godot, focused on implementing responsive character movement, animation state management, and temporary ability-based gameplay mechanics.
